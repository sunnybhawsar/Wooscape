...
HtmlWebpackPlugin.prototype.apply = function (compiler) {
  ...
  /*compiler.hooks.done.tap('make', function (compilation, callback) {
    // Compile the template (queued)
    compilationPromise = childCompiler.hooks.compilation.tap(self.options.template, compiler.context, self.options.filename, compilation)
      .catch(function (err) {
