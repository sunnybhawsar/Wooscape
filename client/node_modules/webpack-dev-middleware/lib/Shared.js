...
module.exports = function Shared(context) {
	...
	context.compiler.hooks.done.tap("done", share.compilerDone);
	context.compiler.hooks.done.tap("invalid", share.compilerInvalid);
	context.compiler.hooks.done.tap("watch-run", share.compilerInvalid);
	context.compiler.hooks.done.tap("run", share.compilerInvalid);
